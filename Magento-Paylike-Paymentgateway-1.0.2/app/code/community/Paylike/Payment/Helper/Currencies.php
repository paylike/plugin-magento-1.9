...
class Paylike_Payment_Helper_Currencies extends Mage_Core_Helper_Abstract {

    private function getPaylikeCurrency($currency_iso_code) {
        $currencies = array(
            'AED' =>
            array(
                'code' => 'AED',
    ...
    public function Ceil($amount, $currencyCode)
    {
        ...
        // those are not shown. That causes ceil to increment the minor amount so we are using round with 4 digits
        // to clear that issue.
        // see http://php.net/manual/ro/function.ceil.php#117341
        return ceil(round($amount * $this->getPaylikeMultiplier($currencyCode),4));
    }
