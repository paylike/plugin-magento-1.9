...
class MagentoRunner extends MagentoTestHelper
{
	...
	public function finalPaylike()
	{
		...
		$this->main_test->assertEquals('THANK YOU FOR YOUR PURCHASE!', $this->getText('.sub-title'), "Checking success message for " . $this->currency);
	}
	...
	public function capture()
	{
		...
		$this->waitForElement('.messages .success-msg');
		$this->main_test->assertEquals('The invoice has been created.', $this->getText('.messages .success-msg'), "Checking capture message for " . $this->currency);
	...
	public function refund()
	{
		...
		$this->waitForElement('.messages .success-msg');
		$this->main_test->assertEquals('The credit memo has been created.', $this->getText('.messages .success-msg'), "Checking refund message for " . $this->currency);
	}
	...
	{
		$element = $this->findChild('.a-center', $this->main_test->findByXpath("//*//table/tbody/tr/td[text()='" . $text . "']/.."));
